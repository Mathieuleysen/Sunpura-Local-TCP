...
async def async_setup_entry(hass: HomeAssistant, config_entry: ConfigEntry,
    ...
    async_add_entities([AECCPowerSetpoint(coordinator, config_entry)])

class AECCPowerSetpoint(CoordinatorEntity[AECCLocalCoordinator], NumberEntity):
    ...
    def native_value(self) -> float | None:
        if self._commanded is None:
            return None
        # Return as int so the UI shows "2400" not "2400.0"
        v = self._commanded
